...
class OptableIdentifiersTests: XCTestCase {
    ...
    func test_extendedIdentifier_roundTrips() throws {
        let eids = [
            ...
            "id5:ID5*UDWnp3JOtWV0ky-bHvEeU4xOVHXCmYeg24YigF8iAymUHplfYSElM3fy79h8p-Fg",
            "utiq:496f5db5-681f-4392-acd5-0d4f6e2f6b88",
            "v:d29c551097b9dd0b82423827f65161232efaf7fc",
            "c:d29c551097b9dd0b82423827f65161232efaf7fc",
            "c1:AaaZza.dh012",
        ]

        for eid in eids {
            let identifier = try XCTUnwrap(OptableIdentifier(extendedIdentifier: eid), eid)
            XCTAssertEqual(eid, identifier.extendedIdentifier)
        }
    ...
    // MARK: - hids
    func test_hids_keepsOnlyHIDCases() throws {
        let hidOnly: [OptableIdentifier] = [
            .emailAddress("foo@bar.com"),
            .phoneNumber("+15123465890"),
            .ipv6Address("2001:0db8:85a3:0000:0000:8a2e:0370:7334"),
            .appleIDFA("496f5db5-681f-4392-acd5-0d4f6e2f6b88"),
        ...
        // Every element is a HID case, so contents and order are preserved.
        XCTAssertEqual(hidOnly.hids.map(\.extendedIdentifier), hidOnly.map(\.extendedIdentifier))
    }

    func test_hids_dropsNonHIDCases() throws {
        let nonHIDs: [OptableIdentifier] = [
            .postalCode("M5V 3L9"),
            .ipv4Address("8.8.8.8"),
            .rokuRIDA("0b179df0-6cd5-49f1-be21-425d002e0d22"),
            .samsungTIFA("e0ef86a8-6ebf-4c9d-9127-e69407fe748d"),
        ...
        XCTAssertTrue(nonHIDs.hids.isEmpty)
    }

    func test_hids_filtersMixedArrayPreservingOrder() throws {
        let mixed: [OptableIdentifier] = [
            .postalCode("M5V 3L9"),
            .emailAddress("foo@bar.com"),
            .ipv4Address("8.8.8.8"),
            .appleIDFA("496f5db5-681f-4392-acd5-0d4f6e2f6b88"),
        ...
        let expected: [OptableIdentifier] = [
            .emailAddress("foo@bar.com"),
            .appleIDFA("496f5db5-681f-4392-acd5-0d4f6e2f6b88"),
            .ipv6Address("2001:0db8:85a3:0000:0000:8a2e:0370:7334"),
            .custom(2, "ppid"),
        ...
        XCTAssertEqual(mixed.hids.map(\.extendedIdentifier), expected.map(\.extendedIdentifier))
    }
}
